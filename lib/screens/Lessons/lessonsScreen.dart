                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/icons/discovery-of-dna-l.jpg'),
                      fit: BoxFit.contain,
                    ),
...
//               padding: const EdgeInsets.all(10),
//               child: Text(
//                 'التركيب البنائي للكروموسوم Structure Chromosome ',
//                 textDirection: TextDirection.rtl,
//                 style: TextStyle(
//                   fontFamily: 'Cairo',
//                   fontSize: 20,
...
//         //     decoration: BoxDecoration(
//         //       image: DecorationImage(
//         //         image: AssetImage('assets/icons/التركيب البنائي للكرومو�سوم.png'),
//         //         fit: BoxFit.contain,
//         //       ),
//         //     ),
//         //   ),
...
//               padding: const EdgeInsets.all(10),
//               child: Text(
//                 'يوجد جزيء DNA في المخلوقات الحية البدائية النوى في السيتوبالزم، ويتكون بشــكل أساســي من حلقة من DNA ويرتبط مع البروتينات، فــي حين يترتب  DNA في المخلوقات الحية الحقيقية النوى في صورة كروموســومات منفردة. يتكون الكروموســوم في اإلنسان من 51  مليونا إلى 245 مليون زوج من القواعد النيتروجينية. وإذا تم بســط سلســلة DNA  مكونة من 140 مليون نيوكليوتيد في ا. فكيف يمكن لكمية DNA هذه أن خط مســتقيم فإن طوله ســيبلغ cm 5 تقريب تترتب داخل خلية مجهرية؟',
//                 textDirection: TextDirection.rtl,
//                 style: TextStyle(
//                   fontFamily: 'Cairo',
//                   color: Colors.white,
...
//               padding: const EdgeInsets.all(10),
//               child: Text(
//                 'لكي يترتب جزيء DNA داخل نواة خلية حقيقية النواة فإنه يلتف حول مجموعة من البروتينات تشبه الخرز تسمى الهستونات،. وألن مجموعات الفوسفات في DNA تحمل شحنة سالبة، فهي تجذب جزيئات ا  نيوكليوسوم  DNA  إلى بروتينات الهستون الموجبة الشحنة، فتكون  جسيما نووي nucleosome ،  ثم تتجمع النيوكليوســومات مع  ا لتكون أليافا كروماتينية، يلتف  بعضها على بعض لتكون تركيب DNA المعروف بالكروموسوم.',
//                 textDirection: TextDirection.rtl,
//                 style: TextStyle(
//                   fontFamily: 'Cairo',
//                   color: Colors.white,
