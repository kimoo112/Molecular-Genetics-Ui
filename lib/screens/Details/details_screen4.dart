...
Widget mainCardWidget(BuildContext context) {
  return ListView(
    ...
    children: [
      ...
      cardWithInfoPage('assets/icons/bold 7 ls4.jpg', 'الهندسه الوراثية', context),
      cardWithInfoPage('assets/icons/bold 8 ls4.jfif', 'الحيوانات المعدلة وراثيا', context),
      cardWithInfoPage('assets/icons/bold 9 ls4.jpg', 'النباتات المعدلة وراثيًّا', context),
      cardWithInfoPage('assets/icons/bold 10 ls4.jpg',
          'البكتيريا المعدّلة وراثيًّا', context),
      cardWithInfoPage(
          'assets/icons/bold 11 ls4.jpg', 'الجينوم البشري', context),  cardWithInfoPage(
